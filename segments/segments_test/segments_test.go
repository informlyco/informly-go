...
func TestSegmentsListSegmentsWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Segments.ListSegments(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestSegmentsListSegmentsWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestSegmentsListSegmentsWithWireMock", "GET", "/segments", nil, 1)
}
