...
func TestHealthHealthCheckWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Health.HealthCheck(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestHealthHealthCheckWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestHealthHealthCheckWithWireMock", "GET", "/health", nil, 1)
}
